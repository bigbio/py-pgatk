...
class EnsemblDataService(ParameterConfiguration):
    ...
    """
        ...
        self._mito_translation_table = 2
        self._header_var_prefix = 'var'
        self._report_reference_seq = False
        self._annotation_field_name = 'CSQ'
        self._transcript_str = 'FEATURE'
        self._consequence_str = 'CONSEQUENCE'
        self._af_field = ''
        self._af_threshold = 0.01
        self._exclude_biotypes = ''
        self._exclude_consequences = 'downstream_gene_variant, upstream_gene_variant, intergenic_variant, intron_variant, synonymous_variant, regulatory_region_variant'
        self._skip_including_all_cds = False
        self._include_biotypes = 'protein_coding,polymorphic_pseudogene,non_stop_decay,nonsense_mediated_decay,IG_C_gene,IG_D_gene,IG_J_gene,IG_V_gene,TR_C_gene,TR_D_gene,TR_J_gene,TR_V_gene,TEC,mRNA'
        self._include_consequences = 'all'
        self._biotype_str = 'biotype'
        self._num_orfs = 3
        self._num_orfs_complement = 0
        self._expression_str = ""
        self._expression_thresh = 5.0
        self._ignore_filters = False
        self._accepted_filters = 'PASS'

        self._proteindb_output = self.get_default_parameters()[self.CONFIG_KEY_DATA][self.PROTEIN_DB_OUTPUT]
        if self.PROTEIN_DB_OUTPUT in self.get_pipeline_parameters() and \
                self.get_pipeline_parameters()[self.PROTEIN_DB_OUTPUT] is not None:
        ...
        if self.TRANSLATION_TABLE in self.get_pipeline_parameters() and \
                self.get_pipeline_parameters()[self.TRANSLATION_TABLE] is not None:
        ...
        if self.MITO_TRANSLATION_TABLE in self.get_pipeline_parameters() and \
                self.get_pipeline_parameters()[self.MITO_TRANSLATION_TABLE] is not None:
        ...
        if self.HEADER_VAR_PREFIX in self.get_pipeline_parameters() and \
                self.get_pipeline_parameters()[self.HEADER_VAR_PREFIX] is not None:
        ...
        if self.REPORT_REFERENCE_SEQ in self.get_pipeline_parameters() and \
                self.get_pipeline_parameters()[self.REPORT_REFERENCE_SEQ] is not None:
        ...
        if self.ANNOTATION_FIELD_NAME in self.get_pipeline_parameters() and \
                self.get_pipeline_parameters()[self.ANNOTATION_FIELD_NAME] is not None:
        ...
        self._transcript_str = self.get_default_parameters()[self.CONFIG_KEY_DATA][self.CONFIG_KEY_VCF][
            self.TRANSCRIPT_STR]
        if self.TRANSCRIPT_STR in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.TRANSCRIPT_STR] is not None:
        ...
        if self.CONSEQUENCE_STR in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.CONSEQUENCE_STR] is not None:
        ...
        self._af_field = self.get_default_parameters()[self.CONFIG_KEY_DATA][self.CONFIG_KEY_VCF][
            self.AF_FIELD]
        if self.AF_FIELD in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.AF_FIELD] is not None:
        ...
        self._af_threshold = self.get_default_parameters()[self.CONFIG_KEY_DATA][self.CONFIG_KEY_VCF][
            self.AF_THRESHOLD]
        if self.AF_THRESHOLD in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.AF_THRESHOLD] is not None:
        ...
        if self.EXCLUDE_BIOTYPES in self.get_pipeline_parameters() and self.get_multiple_options(
                self.get_pipeline_parameters()[self.EXCLUDE_BIOTYPES]) is not None:
        ...
        if self.EXCLUDE_CONSEQUENCES in self.get_pipeline_parameters() and self.get_multiple_options(
                self.get_pipeline_parameters()[self.EXCLUDE_CONSEQUENCES]) is not None:
            self._exclude_consequences = self.get_multiple_options(
        ...
        if self.SKIP_INCLUDING_ALL_CDS in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.SKIP_INCLUDING_ALL_CDS] is not None:
        ...
        if self.INCLUDE_BIOTYPES in self.get_pipeline_parameters() and self.get_multiple_options(
                self.get_pipeline_parameters()[self.INCLUDE_BIOTYPES]) is not None:
        ...
        if self.INCLUDE_CONSEQUENCES in self.get_pipeline_parameters() and self.get_multiple_options(
                self.get_pipeline_parameters()[self.INCLUDE_CONSEQUENCES]) is not None:
            self._include_consequences = self.get_multiple_options(
        ...
        self._biotype_str = self.get_default_parameters()[self.CONFIG_KEY_DATA][self.CONFIG_KEY_VCF][
            self.BIOTYPE_STR]
        if self.BIOTYPE_STR in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.BIOTYPE_STR] is not None:
        ...
        if self.NUM_ORFS in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.NUM_ORFS] is not None:
        ...
        if self.NUM_ORFS_COMPLEMENT in self.get_pipeline_parameters() and \
                self.get_pipeline_parameters()[self.NUM_ORFS_COMPLEMENT] is not None:
        ...
        self._expression_str = self.get_default_parameters()[self.CONFIG_KEY_DATA][self.CONFIG_KEY_VCF][
            self.EXPRESSION_STR]
        if self.EXPRESSION_STR in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.EXPRESSION_STR] is not None:
        ...
        if self.EXPRESSION_THRESH in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.EXPRESSION_THRESH] is not None:
        ...
        self._ignore_filters = self.get_default_parameters()[self.CONFIG_KEY_DATA][self.CONFIG_KEY_VCF][
            self.IGNORE_FILTERS]
        if self.IGNORE_FILTERS in self.get_pipeline_parameters() and self.get_pipeline_parameters()[
            self.IGNORE_FILTERS] is not None:
        ...
        if self.ACCEPTED_FILTERS in self.get_pipeline_parameters() and self.get_multiple_options(
                self.get_pipeline_parameters()[self.ACCEPTED_FILTERS]) is not None:
            self._accepted_filters = self.get_multiple_options(
        ...
        if self._annotation_field_name:
            ...
            try:
                ...
                msg = "Error: Unable to find {} or {} in metadata header {} of VCF file: {} ".format(
                    self._transcript_str, self._consequence_str, annotation_cols, vcf_file)
                self.get_logger().debug(msg)
