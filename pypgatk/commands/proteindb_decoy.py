...
@click.option('-m', '--method', type=click.Choice(['protein-reverse', 'protein-shuffle', 'decoypyrat'], case_sensitive=False),
...
@click.option('-e', '--enzyme', default='Trypsin', help='Enzyme used for clevage the protein sequence (Default: Trypsin)')
...
@click.option('--min_peptide_length', type=int, help='Set minimum length of peptides (Default = 5)', default = 5)
@click.option('--max_peptide_length', type=int, help='Set maximum length of peptides (Default = 100)', default = 100)
