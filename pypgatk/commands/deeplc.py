...
try:
  ...
  try:
    ...
    logging.info("No configuration file available -- ")
...
@click.option('--novel-peptides', help ='This parameter will allow to remove from the peptide list the novel peptides', is_flag = True)
@click.pass_context
def generate_deeplc(ctx, config_file, input_file, output_file, decoy_prefix: str, peptide_classes_prefix: str, novel_peptides: bool):
